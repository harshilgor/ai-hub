        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group bg-gray-50 dark:bg-dark-card rounded-2xl p-8 hover:shadow-lg transition-all border border-gray-100 dark:border-dark-border"
            >
              <div className="w-14 h-14 rounded-xl bg-gray-900 dark:bg-gray-100 flex items-center justify-center text-white dark:text-gray-900 mb-5 group-hover:scale-110 transition-transform">
                {feature.icon}
              </div>
